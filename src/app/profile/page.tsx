    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 mb-8 border-b border-zinc-800/80">
        <div>
          <Link
            href="/"
            className="inline-flex items-center gap-1.5 text-xs font-mono text-zinc-400 hover:text-emerald-400 mb-2 transition-colors"
          >
            <ArrowLeft className="w-3.5 h-3.5" />
            <span>Back to Live Job Feed</span>
          </Link>
          <h1 className="text-2xl font-bold font-mono text-zinc-100">Candidate Search Profile</h1>
      ...
      {/* Save Success Notice */}
      {saveMessage && (
        <div className="mb-6 p-4 rounded-xl bg-zinc-900 border border-emerald-500/40 text-emerald-400 font-mono text-xs flex items-center justify-between gap-3 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <form onSubmit={handleSave} className="lg:col-span-8 space-y-6">
          ...
          <div className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800 space-y-5 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <div className="relative group">
                <div className="w-16 h-16 rounded-xl bg-zinc-900 border border-zinc-700/80 flex items-center justify-center font-mono font-bold text-lg text-emerald-400 overflow-hidden shadow-inner">
                  {avatar ? (
                    <img
                      src={avatar}
                      alt={name}
              ...
              <div className="flex-1 w-full space-y-1">
                <label className="block font-mono text-xs text-zinc-400">Avatar Image URL</label>
                <input
                  type="url"
                  value={avatar}
                  onChange={(e) => setAvatar(e.target.value)}
                  placeholder="https://example.com/avatar.jpg (optional)"
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-zinc-700 font-mono"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block font-mono text-xs text-zinc-400 mb-1">Full Name</label>
                <input
                  type="text"
                  required
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 focus:outline-none focus:border-zinc-700"
                  placeholder="e.g. Alex Chen"
                />
              </div>

              <div>
                <label className="block font-mono text-xs text-zinc-400 mb-1">Email Address</label>
                <input
                  type="email"
                  required
                  value={email}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 focus:outline-none focus:border-zinc-700 font-mono"
                >
            ...
            <div>
              ...
              <div className="flex items-center gap-2 max-w-sm">
                <input
                  ...
                  className="bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-200 placeholder-zinc-500 focus:outline-none focus:border-zinc-700 flex-1"
                />
                <button
                  type="button"
                  onClick={handleAddCustomIndustry}
                  className="px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 text-xs font-mono font-medium transition-colors"
                >
                  Add
                </button>
              </div>
          ...
          <div className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800 space-y-5 shadow-sm">
            ...
            {/* Editable Skill Tags */}
            <div className="flex flex-wrap items-center gap-2 min-h-[44px] p-3 rounded-xl bg-zinc-900/60 border border-zinc-800/80">
              {skills.map((skill, index) => {
                ...
                if (isEditing) {
                  return (
                    <div
                      key={index}
                      className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-zinc-800 border border-emerald-500 text-xs font-mono text-zinc-100"
                    >
                      <input
                        type="text"
                        autoFocus
                        ...
                        className="bg-transparent border-none outline-none text-xs font-mono text-zinc-100 w-24"
                      />
                      <button
                        type="button"
                ...
                return (
                  <span
                    key={skill}
                    className="group inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-zinc-900 hover:bg-zinc-800 border border-zinc-700/80 text-xs font-mono text-zinc-200 transition-colors"
                  >
                    <span>{skill}</span>
                    <button
                      type="button"
                      onClick={() => startEditSkill(index)}
                      className="opacity-0 group-hover:opacity-100 text-zinc-400 hover:text-zinc-200 transition-opacity p-0.5"
                      title="Edit skill"
                    >
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-zinc-700 font-mono"
              />
              <button
                type="button"
                onClick={() => handleAddSkill()}
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 text-xs font-mono font-medium transition-colors"
              >
              ...
              <div className="flex flex-wrap gap-1.5">
                {SUGGESTED_SKILLS.filter(
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-mono bg-zinc-900/60 hover:bg-zinc-800 border border-zinc-800 text-zinc-400 hover:text-emerald-400 transition-colors"
                  >
          ...
          <div className="p-6 rounded-2xl bg-zinc-950 border border-zinc-800 space-y-5 shadow-sm">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 mb-2 p-2.5 rounded-lg bg-zinc-900/60 border border-zinc-800">
                {preferredRoles.map((role, idx) => (
                  <span
                    key={idx}
                    className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded bg-zinc-900 border border-zinc-700 text-xs font-mono text-zinc-200"
                  >
                    <span>{role}</span>
                    <button
                      type="button"
              ...
              <div className="flex items-center gap-2 mb-2">
                <input
                  ...
                  className="flex-1 bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-1.5 text-xs text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-zinc-700"
                />
                <button
                  type="button"
                  onClick={() => handleAddRole()}
                  className="px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 text-xs font-mono"
                >
                  Add
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {PRESET_ROLES.filter((r) => !preferredRoles.includes(r)).map((r) => (
                  <button
                    ...
                    className="text-[11px] font-mono px-2 py-0.5 rounded bg-zinc-900 border border-zinc-800 text-zinc-400 hover:text-zinc-200"
                  >
                    + {r}
                  </button>
                ))}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-100 font-mono focus:outline-none focus:border-zinc-700"
                />
          ...
          {/* Bottom Save Action */}
          <div className="p-5 rounded-2xl bg-zinc-950 border border-zinc-800 flex items-center justify-between gap-4">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="p-5 rounded-2xl bg-zinc-950 border border-zinc-800 shadow-sm space-y-4">
            ...
            <div className="space-y-2 pt-2 border-t border-zinc-800/80 text-xs font-mono">
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.name && completeness.checks.email ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Personal info & headline</span>
                </span>
                <span className={completeness.checks.name && completeness.checks.email ? "text-emerald-400" : "text-zinc-500"}>
              ...
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.skills ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Skills (3+ required)</span>
                </span>
                <span className={completeness.checks.skills ? "text-emerald-400" : "text-zinc-500"}>
                  {skills.length} / 3
                </span>
              </div>
              ...
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.experience ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Experience level</span>
                </span>
                <span className={completeness.checks.experience ? "text-emerald-400" : "text-zinc-500"}>
              ...
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.locations ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Target locations</span>
                </span>
                <span className={completeness.checks.locations ? "text-emerald-400" : "text-zinc-500"}>
              ...
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.workModes ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Work mode preferences</span>
                </span>
                <span className={completeness.checks.workModes ? "text-emerald-400" : "text-zinc-500"}>
              ...
              <div className="flex items-center justify-between text-zinc-300">
                <span className="flex items-center gap-2">
                  <CheckCircle2 className={`w-3.5 h-3.5 ${completeness.checks.salary ? "text-emerald-400" : "text-zinc-600"}`} />
                  <span>Salary expectations</span>
                </span>
                <span className={completeness.checks.salary ? "text-emerald-400" : "text-zinc-500"}>
            ...
            <div className="space-y-2.5 pt-1 text-xs font-mono">
              <div className="p-2.5 rounded-lg bg-zinc-900 border border-zinc-800/80">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-zinc-200">Skills</span>
                  <span className="text-emerald-400 font-bold">50% Weight</span>
                </div>
              ...
              <div className="p-2.5 rounded-lg bg-zinc-900 border border-zinc-800/80">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-zinc-200">Work Mode</span>
              ...
              <div className="p-2.5 rounded-lg bg-zinc-900 border border-zinc-800/80">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-zinc-200">Experience</span>
                  <span className="text-cyan-400 font-bold">20% Weight</span>
                </div>
                <p className="text-[11px] text-zinc-400 leading-normal font-sans">
              ...
              <div className="p-2.5 rounded-lg bg-zinc-900 border border-zinc-800/80">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-amber-400 font-bold">10% Weight</span>
                </div>
                <p className="text-[11px] text-zinc-400 leading-normal font-sans">
              ...
              <div className="p-2.5 rounded-lg bg-zinc-900 border border-zinc-800/80">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-bold text-zinc-200">Job Type</span>
                  <span className="text-zinc-400 font-bold">Feed Filter</span>
                </div>
                <p className="text-[11px] text-zinc-400 leading-normal font-sans">
          ...
          <div className="p-5 rounded-2xl bg-zinc-950 border border-zinc-800 shadow-sm space-y-3">
            <span className="text-xs font-mono uppercase tracking-wider text-zinc-500 font-semibold block">
              Candidate Preview
            </span>

            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-zinc-900 border border-zinc-700 flex items-center justify-center font-mono font-bold text-emerald-400 text-sm">
                {avatar ? (
              ...
              <div className="min-w-0">
                <h4 className="text-sm font-bold font-mono text-zinc-100 truncate">{name}</h4>
                <p className="text-xs text-zinc-400 truncate">{currentRole || headline}</p>
              </div>
            </div>

            <div className="text-xs font-mono text-zinc-400 space-y-1 pt-2 border-t border-zinc-800/80">
